-- Migration: Prevent Self-Commissions for Classe A (CELD)
-- Description: Updates public.distribute_commissions() to block affiliates from receiving commissions on their own orders.
...
-- Recriar a trigger associada para garantir a vinculação correta
