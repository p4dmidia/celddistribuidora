-- Migration: CELD Activation Logic (Stage 1)
-- Naming: 20260624_celd_activation_stage_1.sql
-- Description: Adds active_until columns and triggers automatic 30-day activation when an order is updated to 'Pago' for Plano Único CELD (R$ 300.00).

-- 1. Ensure active_until columns exist on affiliates and user_settings tables
...
-- 2. Create or replace the function to handle CELD activation
