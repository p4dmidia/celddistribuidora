            ...
            <div className="max-w-md w-full">
                ...
                <div className="text-center mb-10">
                    <div className="inline-flex items-center justify-center mb-6">
                        <img src="/assets/logo.png" alt="CELD Distribuidora" className="h-24 w-auto drop-shadow-sm" />
                    </div>
                ...
                <div className="bg-white rounded-[2rem] shadow-xl shadow-slate-200/60 p-10 border border-slate-100">
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full bg-slate-50 border border-slate-100 rounded-2xl p-4 pl-12 outline-none focus:border-emerald-500 focus:bg-white transition-all"
                                />
                            </div>
                        </div>
                        ...
                        <div className="space-y-2">
                            <div className="flex justify-between items-center ml-1">
                                ...
                                <Link to="/forgot-password" size="sm" className="text-xs font-bold text-emerald-500 hover:underline">Esqueceu a senha?</Link>
                            </div>
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    onChange={handleChange}
                                    placeholder="••••••••"
                                    className="w-full bg-slate-50 border border-slate-100 rounded-2xl p-4 pl-12 pr-12 outline-none focus:border-emerald-500 focus:bg-white transition-all"
                                />
                                <button
                                    type="button"
                        ...
                        >
                            ...
                            <LogIn className="w-5 h-5 text-emerald-500 group-hover:translate-x-1 transition-transform" />
                        </button>
                    </form>
                    ...
                    <div className="mt-10 pt-8 border-t border-slate-100 text-center">
                        ...
                        <Link to="/register" className="mt-4 inline-flex items-center gap-2 text-[#0B1221] font-black hover:text-emerald-500 transition-colors group">
                            CADASTRAR-SE AGORA
                ...
                <p className="text-center mt-8 text-xs text-slate-400 uppercase tracking-widest font-bold">
                    Problemas com acesso? <a href="#" className="text-emerald-500">Suporte CELD</a>
                </p>
            </div>
        </div>
    );
