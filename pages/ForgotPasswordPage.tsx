            ...
            <div className="max-w-md w-full">
                ...
                <div className="bg-white rounded-[2rem] shadow-xl shadow-slate-200/60 p-10 border border-slate-100">
                    {!submitted ? (
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            >
                                ...
                                <Send className="w-5 h-5 text-emerald-500 group-hover:translate-x-1 transition-transform" />
                            </button>
                        </form>
                    ) : (
                    ...
                    <div className="mt-10 pt-8 border-t border-slate-100 text-center">
                        <Link to="/login" className="inline-flex items-center gap-2 text-[#0B1221] font-black hover:text-emerald-500 transition-colors group">
