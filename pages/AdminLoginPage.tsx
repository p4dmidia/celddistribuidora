            ...
            <div className="w-full max-w-[440px] relative z-10 transition-all duration-700 animate-in fade-in slide-in-from-bottom-8">
                ...
                <div className="text-center mb-10">
                    <div className="inline-flex items-center justify-center mb-6">
                        <img src="/assets/logo.png" alt="CELD Distribuidora" className="h-20 w-auto object-contain" />
                    </div>
                    ...
                    <form onSubmit={handleLogin} className="space-y-6">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative group/input">
                                <div className="absolute left-5 top-1/2 -translate-y-1/2 text-slate-500 group-focus-within/input:text-emerald-500 transition-colors">
                                ...
                                <input
                                    ...
                                    placeholder="admin@celddistribuidora.com.br"
                                    className="w-full bg-white/5 border border-white/10 rounded-2xl py-4 pl-14 pr-6 text-white placeholder:text-slate-600 outline-none focus:border-emerald-500/50 focus:bg-white/10 transition-all font-medium"
                                    required
                                />
                            </div>
                        </div>
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative group/input">
                                ...
                                <input
                                    ...
                                    placeholder="••••••••••••"
                                    className="w-full bg-white/5 border border-white/10 rounded-2xl py-4 pl-14 pr-14 text-white placeholder:text-slate-600 outline-none focus:border-emerald-500/50 focus:bg-white/10 transition-all font-medium"
                                    required
                                />
                                <button
                                    type="button"
                        ...
                        <button
                            type="submit"
                            disabled={isLoading}
                            className="w-full bg-emerald-500 hover:bg-emerald-600 text-white py-5 rounded-2xl font-black transition-all flex items-center justify-center gap-2 group shadow-xl shadow-emerald-500/10 disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                            {isLoading ? (
                ...
                <div className="mt-10 text-center">
                    <p className="text-slate-600 text-xs font-medium">
                        © 2026 CELD - Sistema de Gestão Interna
                    </p>
                </div>
            </div>
        </div>
