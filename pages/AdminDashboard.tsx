...
const AdminDashboard: React.FC = () => {
    ...
    const fetchDashboardData = async () => {
        ...
        try {
            ...
            setCategoryData([
                { name: 'Cesta Básica', value: totalSalesValue || 300, color: '#10b981' }
            ]);
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-8">
                    <div className="lg:col-span-2 bg-white rounded-[2.5rem] border border-slate-100 p-6 md:p-8 shadow-sm">
                        <div className="flex flex-col sm:flex-row justify-between sm:items-center gap-4 mb-8">
                            ...
                            <select 
                                ...
                                className="bg-slate-50 border border-slate-200 rounded-xl px-4 py-2 text-sm font-bold text-[#05080F] outline-none w-full sm:w-auto cursor-pointer hover:border-emerald-500 transition-colors"
                            >
                    ...
                    <div className="bg-white rounded-[2.5rem] border border-slate-100 p-6 md:p-8 shadow-sm">
                        <div className="flex justify-between items-center mb-8">
                            ...
                            <button className="text-emerald-500 hover:text-[#05080F] transition-colors"><MoreHorizontal /></button>
                        </div>
                                ...
                                recentAffiliates.map((aff, idx) => (
                                    <div key={idx} className="flex items-center justify-between group cursor-pointer p-2 hover:bg-slate-50 rounded-2xl transition-all">
                                        <div className="flex items-center gap-4">
                                            <div className="w-10 h-10 md:w-12 md:h-12 rounded-xl bg-[#05080F] flex items-center justify-center font-black text-emerald-500 shrink-0 text-xs md:text-base">
                                                {aff.name.charAt(0)}
                                            </div>
                                        ...
                                        <div className="text-right shrink-0">
                                            <p className="text-[10px] font-black text-emerald-500 uppercase tracking-widest">{aff.plan}</p>
